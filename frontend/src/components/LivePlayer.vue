...
hlsInstance = new Hls({
    ...
    liveSyncDuration:            5,     // Target 2 seconds behind real-time
    liveMaxLatencyDuration:      15,     // If delay exceeds 4 seconds, jump straight to the live edge!
    maxBufferLength:             25,     // Only buffer 2 seconds in RAM
